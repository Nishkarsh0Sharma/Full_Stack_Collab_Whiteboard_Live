    ...
    <div className = {classes.container}>
       ...
       <div className = {classes.selectOptionContainer}>
            <div className = {classes.toolBoxLabel}>
                { activeToolItem === TOOL_ITEMS.TEXT ? "Font Size" : 
                  activeToolItem === TOOL_ITEMS.BRUSH ? "Brush Thickness" : "Line Thickness" }
            </div>
            <input 
                type="range" 
                min = { 
                    activeToolItem === TOOL_ITEMS.TEXT ? 12 : 
                    activeToolItem === TOOL_ITEMS.BRUSH ? 1 : 1
                }
                max = {  
                    activeToolItem === TOOL_ITEMS.TEXT ? 64 : 
                    activeToolItem === TOOL_ITEMS.BRUSH ? 20 : 10
                }
                step = {1}
                value = {size}
            ...
            <div className={classes.sizeDisplay}>
                {activeToolItem === TOOL_ITEMS.BRUSH ? `${size}px` : size}
            </div>
        </div>}
    </div>
  )
